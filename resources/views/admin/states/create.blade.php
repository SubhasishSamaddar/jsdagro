        ...
        <div class="row"> 
            <div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="state_name" id="state_name" required value="{{ old('state_name') }}"/>
				</div>
				<div class="form-group">
					<label for="state_code">ISO 3 Code</label>
					<input type="text" class="form-control" name="state_code" id="state_code" required value="{{ old('state_code') }}"/>
				</div> 
            </div>    
            <div class="col-md-6">
                <div class="form-group">
					...
					<select name="country_id" id="country_id" class="form-control" required >
						...
						<option value="{{ $value->id}}" {{ ($value->id==old('country_id'))?'selected':''}}>{{ $value->country_name}}</option>
                        @endforeach
                    </select> 
				</div>
            </div> 
