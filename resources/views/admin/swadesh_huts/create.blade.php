        ...
        <div class="row">
            <div class="col-md-6">
				...
				<div class="col-md-6">
					...
					<input type="text" name="invoice_prefix" id="invoice_prefix" required value="{{ old('invoice_prefix') }}"><br/>
				</div>

				<div class="col-md-6">
					<label for="address">Address</label><br/>
					<textarea name="address" id="address" rows="5" cols="80" style="" required >{{ old('address') }}</textarea><br/>
            ...
            <div class="col-md-6">
				...
				<textarea name="cover_area_pincodes" id="cover_area_pincodes" rows="5" cols="80" style="" required >{{ old('cover_area_pincodes') }}</textarea><br/>
            </div>
