...
<div class="row mb-2">
	...
	<ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{ route('package_location.index') }}">Package Locations</a></li>
...
@section('content')
	...
	<div class="card">
		<div class="card-header">
			<div class="pull-left">
	            <h4>Edit Package Location</h4>
	        </div>
        </div>

		<div class="card-body">
        <form method="post" action="{{ route('package_location.update', $details->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <label for="description">Cover Area</label><br/>
				<textarea name="cover_area" id="cover_area" rows="5" cols="80" style="">{{$details->cover_area}}</textarea><br/>
