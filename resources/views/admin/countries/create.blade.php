        ...
        <div class="row"> 
            <div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="country_name" id="country_name" required value="{{ old('country_name') }}"/>
				</div>
				<div class="form-group">
					<label for="country_code2">ISO 2 Code</label>
					<input type="text" class="form-control" name="country_code2" id="country_code2" required value="{{ old('country_code2') }}"/>
				</div>
				<div class="form-group">
					<label for="country_code3">ISO 3 Code</label>
					<input type="text" class="form-control" name="country_code3" id="country_code3" required value="{{ old('country_code3') }}"/>
				</div> 
            </div>    
            <div class="col-md-6">
				<div class="form-group">
