						...
						<div class="product-box">
								...
								<div class="prodBtm">
								   ...
								   <?php 
									...
									<button type="submit" id="processtoshippingaddtocart{{$data->id}}" onclick="addToCart({{ $data->id }});" class="homeshopbtn">Add to cart</button>

									<button style="display:none;background-color:#FF0000; border:#FF0000 1px solid!important;" type="submit" id="processtoshippingoutofstock{{$data->id}}" class="homeshopbtn">Out of Stock</button>
									...
									?>
									<button type="button" id="processtoshippingoutofstock{{$data->id}}" style="background-color:#FF0000; border:#FF0000 1px solid!important;" class="homeshopbtn">Out Of Stock</button>

									<button style="display:none;" type="submit" id="processtoshippingaddtocart{{$data->id}}" onclick="addToCart({{ $data->id }});" class="homeshopbtn">Add to cart</button>
...

{
	...
	$.ajax({      
		...
		//	$("#price_container_"+pid).html('₹'+(data.price));
			...
			if(data.buttonDisable==0)
			{
				$("#processtoshippingaddtocart"+pid).show();
				$("#processtoshippingoutofstock"+pid).hide();
			}
			else 
			{
				$("#processtoshippingaddtocart"+pid).hide();
				$("#processtoshippingoutofstock"+pid).show();
			}
