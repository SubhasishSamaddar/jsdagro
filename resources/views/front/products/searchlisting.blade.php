...
<!-- New Design -->
	...
	<div class="subCat">
	    ...
	    <div class="subCatInr">
	        ...
	        <div class="catName">
	            <h3><a href="{{ route('product-category', $category_details->id) }}">{{ $category_details->name }}</a></h3>
	        </div>
	    </div>
		@endforeach
		@endif
	...
	<div class="pdtlist product-listing-outer" style="width:100%;float:none;">
	    <div class="product-listing-head">
		    ...
		    <a href="{{ route('product-category', $category_details->id) }}">View All</a>
	    </div>
	    <div class="product-list-view">
			<div class="product-boxes"> 
				...
				if(count($id_array)>0)
				{
					$get_category_products = Helper::get_products_by_category_id_array($id_array,3);
				}
				else 
				{
					$get_category_products = Helper::get_products_by_category_id($category_details->id,3);
				}
			    ...
			    <div class="product-box">
					...
					@php
					if (date('H') < 17) {
						echo "<span style='color:green;'>Delivery: Today</span>";
					}else {
						echo "<span style='color:red;'>Delivery: Tomorrow</span>";
					}
					@endphp
	...
	<div class="pdtlist product-listing-outer" style="width:100%;float:none;">
		...
		<div class="pagination" style="float:right;">{{ $products->appends(request()->input())->links() }}</div>
    </div>
    </div>
	@endif
	...
	$.ajax({      
		...
		function(data){  
		   ...
		   // if( data.discount >0 ) {
			...
			{
				 var show_percentage = discount_percentage;
			}
